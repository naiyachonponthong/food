...
import { Receipt, CheckCircle2, Crown, ArrowRight } from "lucide-react";
                ...
                >
                  <div className="flex items-center justify-between bg-blue-50 px-4 py-2.5">
                    <div>
                      <div className="flex items-baseline gap-2">
                        <div className="text-xl font-bold tabular text-ink-800">
                          {tableDisplayCode(s.tableName)}
                        </div>
                        {s.isBuffet && (
                          <span className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-amber-400 to-orange-500 px-2 py-0.5 text-[9px] font-bold uppercase text-white">
                  ...
                  <div className="grid grid-cols-2 gap-2 border-t border-cream-200 bg-cream-50 p-3">
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-1 rounded-xl bg-blue-600 py-2 text-xs font-semibold text-white shadow-pop hover:bg-blue-700"
                    >
                      รับชำระ
                ...
                {paid.map((p) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline gap-2">
                        <span className="rounded-md bg-cream-200 px-1.5 py-0.5 font-mono text-[10px] font-bold text-ink-800">
                          {tableDisplayCode(p.tableName)}
                        </span>
